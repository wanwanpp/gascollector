...
import com.gasmonitor.entity.CurrencyConversion;
import com.gasmonitor.entity.CurrencyExchange;
import com.gasmonitor.entity.Rate;
import com.gasmonitor.service.CurrencyConversionService;
...
public class CurrencyController {
    ...
    public ResponseEntity<CurrencyExchange> addNewRates(@RequestBody CurrencyExchange currencyExchange) throws Exception {
        log.info("得到 new : {}", currencyExchange);
